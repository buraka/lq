...
mongoClient.open(function(err, mongoClient) {
    ...
    db.collection('employees', {strict:true}, function(err, collection) {
        if (err) {
            ...
            logger.info("The 'employees' collection doesn't exist. Creating it with sample data...");
            populateDB();
        }
    });
});
...
exports.findById = function(req, res) {
    ...
    log.logWarn(req.params);
    var id = parseInt(req.params.id);
    console.log('findById: ' + id);
    log.logWarn('findById: ' + id);
...
var populateDB = function() {
    ...
    log.logWarn("Populating employee database...");
    var employees = [
